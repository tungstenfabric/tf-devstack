...
ifdown eth1
ifup eth1
sudo -E ./tf-devstack/providers/common/rhel_provisioning.sh
yum install -y wget
wget https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm
yum localinstall -y ./epel-release-latest-7.noarch.rpm
export Hostname=\${ipa_instance}.\${domain}
export FreeIPAIP=\${ipa_prov_ip}
export DirectoryManagerPassword=\$IPMI_PASSWORD
export AdminPassword=\${IPMI_PASSWORD}
export UndercloudFQDN=\${undercloud_instance}.\${domain}
export CLOUD_DOMAIN_NAME=\${domain}
