...
[[ ! -f /var/log/ipaclient-install.log ]] || sudo cp /var/log/ipaclient-install.log \$TF_LOG_DIR
EOF
...
./collect_logs.sh collect_system_stats
[[ ! -f /var/log/ipaclient-install.log ]] || sudo cp /var/log/ipaclient-install.log \$TF_LOG_DIR
[[ ! -f /var/log/ipaserver-install.log ]] || sudo cp /var/log/ipaserver-install.log \$TF_LOG_DIR
EOF
