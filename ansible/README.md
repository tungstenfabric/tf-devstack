...
- instance with 8 virtual CPU, 32 GB of RAM and 120 GB of disk space for controller nodes
...
User has to have sudoers right on all the nodes and the ssh users can run sudo without password right on all the nodes.
...
Note: IPs should be from inner network Amazon (172. ...)
