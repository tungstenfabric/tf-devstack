...
SRIOV_PHYSNET=${SRIOV_PHYSNET:-'physnet1'}
SRIOV_PHYSINT=${SRIOV_PHYSINT:-'ens2f1'}
SRIOV_VF_NUMBER=${SRIOV_VF_NUMBER:-7}
...
function collect_deployment_env() {
    ...
    for node in $sriov_agent_nodes; do
        ...
        DEPLOYMENT_ENV['SRIOV_CONFIGURATION']+="$node:$SRIOV_PHYSNET:$SRIOV_PHYSINT:$SRIOV_VF_NUMBER";
    done
