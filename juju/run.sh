...
function openstack() {
    ...
    echo "INFO: [openstack] CONTROLLERS_COUNT=$CONTROLLERS_COUNT"
    echo "INFO: [openstack] AGENTS_COUNT=$AGENTS_COUNT"
...
function tf() {
    ...
    echo "INFO: [tf] CONTROLLERS_COUNT=$CONTROLLERS_COUNT"
    echo "INFO: [tf] AGENTS_COUNT=$AGENTS_COUNT"
    echo "INFO: [tf] CONTROLLER_NODES=$CONTROLLER_NODES"
    echo "INFO: [tf] AGENT_NODES=$AGENT_NODES" 
    if [ $CLOUD == 'maas' ] ; then
