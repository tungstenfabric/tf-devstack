...
- instance with 8 virtual CPU, 16 GB of RAM and 150 GB of disk space to deploy all-in-one
- Ubuntu 18.04
...
-  If the vrouter agent does not start after installation, this is probably due to a version of the Linux kernel. There is no support for 5.x versions now. You can downgrade kernel version for Ubuntu 18.
...
```
 ...
 Update your system kernel to the latest version (yum update -y) and reboot your machine
